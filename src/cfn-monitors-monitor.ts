 ...
 * @stability external
 * @link arn:aws:cloudformation:us-west-2::type/resource/7171b96e5d207b947eb72ca9ce05247c246de623/Datadog-Monitors-Monitor
 */
export class CfnMonitor extends cdk.CfnResource {
  ...
  constructor(scope: cdk.Construct, id: string, props: CfnMonitorProps) {
    super(scope, id, {
      ...
      properties: toJson_CfnMonitorProps(props)!,
    })
